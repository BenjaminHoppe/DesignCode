        ...
        ZStack(alignment: .top){
            VStack(alignment: .leading, spacing: 30.0) {
                ...
                Text("About this course")
                 ...
                 Text("Minimal coding experience required, such as in HTML and CSS. Please note that Xcode 11 and Catalina are essential. Once you get everything installed, it'll get a lot friendlier! I added a bunch of troubleshoots")
