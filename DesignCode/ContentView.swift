...
//                    .repeatForever(autoreverses: true)
            ...
            CardView()
                ...
                .clipShape(RoundedRectangle(cornerRadius: showCard ? 30 : 20, style: RoundedCornerStyle.continuous))
//                .cornerRadius(20)
                .shadow(radius: 20)
                .offset(x: viewState.width, y: viewState.height)
            ...
            .gesture(
//                Stores value of gesutue in state
...
//            To show value of position on BottomCardView
        ...
        VStack(spacing: 20) {
            ...
            HStack(spacing: 20.0) {
                ...
                VStack(alignment: .leading, spacing: 8.0) {
                    Text("Swift UI")
                        .fontWeight(.bold)
                    Text("12 o 12 sections completed\n10 hours spent so far")
                        .font(.footnote)
